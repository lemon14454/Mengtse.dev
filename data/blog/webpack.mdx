...
summary: "最基本的 Webpack 配置觀念"
image: "/static/images/banner.jpeg"
---

[基本 Webpack 配置連結](https://github.com/lemon14454/webpack-practice)
...
PostCSS 是後處理器，而 LESS、SASS、SCSS 屬於預處理器。
...
- @babel/preset-env: 可以使用 es2015+ 的語法
