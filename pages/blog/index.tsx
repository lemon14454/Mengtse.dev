  ...
  return (
    ...
    >
      <div className="flex flex-col items-start justify-center max-w-2xl mx-auto mb-16 w-full">
        <div className="flex items-center justify-between gap-12 w-full mb-8">
          <h1 className="whitespace-nowrap mb-4 text-3xl font-bold tracking-tight text-black md:text-5xl dark:text-white">
            文章
          </h1>
